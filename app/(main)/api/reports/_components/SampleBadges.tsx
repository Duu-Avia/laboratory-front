  ...
  return (
    <div className="rounded-2xl border border-slate-200/60 dark:border-slate-800/60 bg-white dark:bg-slate-900 p-6 shadow-sm">
      ...
      <div className="flex items-center gap-3 mb-4">
        <div className="font-bold pl-2 text-lg text-slate-900 dark:text-white">
          Үүсгэсэн сорьцууд
        </div>
      </div>

      <div className="font-semibold text-gray-600 text-sm pl-2 pb-3">
        Сорьц өгсөн : {samples[0]?.sampled_by}{" "}
      </div>
      {/* Sample Badges */}

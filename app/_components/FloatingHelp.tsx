...
const HELP_CONTENT: Record<string, HelpSection> = {
    ...
    items: [
      {
        ...
        steps: [
          ...
          "Ингэснээр сорьц шинжилгээ зэргийг багтаасан тайлан үүснэ",
        ],
      },
      {
        label: "Тайлан хайх & шүүх",
        steps: [
          "Хайлтын талбарт Тайлангийн дугаар эсвэл нэр бичнэ",
          "Төлөвөөр шүүхийн тулд шүүлтүүрийн товч ашиглана",
          "Огноогоор эрэмбэлэх боломжтой",
        ],
      },
      {
        label: "Тайлангийн төлөв ойлгох",
      steps: [
        "Сорьц хүлээгдэж байна - > Сорьц лабораторид ирсэн, шинжилгээнд бэлэн байна",
        "Шинжилгээ хийгдсэн -> Лабораторийн ажилтан шинжилгээний үр дүнг оруулж байна",
        "Шалгагдаж байна -> Тайлан хянагч инженер шалгаж байна",
      ]
      },
      {
        label: "Тайлан засах",
        steps: [
          "Тайлангийн мөрөн дээр дарж дэлгэрэнгүй хуудас руу орно",
          "Засах товч дарна",
          "Мэдээллээ өөрчилнө",
          "Хадгалах товч дарна",
        ],
  ...
  "/approve": {
    ...
    items: [
      {
        label: "Хүсэлт баталгаажуулах",
        steps: [
          "Баталгаажуулах хүсэлтийн жагсаалтаас сонгоно",
          "Шинжилгээний үр дүнг шалгана",
          "'Баталгаажуулах' товч дарна",
          "Нууц үгээ оруулж баталгаажуулна",
        ],
      },
      {
        label: "Хүсэлт буцаах",
  ...
  "/employees": {
    ...
    items: [
      {
        label: "Ажилтны жагсаалт харах",
        description: "Бүх ажилтны нэр, имэйл, эрхийн түвшинг жагсаалтаас харах боломжтой.",
      },
      {
        label: "Шинэ ажилтан нэмэх",
        roles: ELEVATED_ROLES,
        steps: [
          "'Шинэ ажилтан' товч дарна",
